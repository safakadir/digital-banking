...
/**
 * Validator for withdraw request
 * @param event - API Gateway event
 */
export const validateWithdrawRequest = (event: APIGatewayProxyEvent): void => {
  ...
  if (body.amount < 1) {
    throw new ValidationError('Minimum withdrawal amount is 1');
  }
};
