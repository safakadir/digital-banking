...
export class QueryService {
   ...
   */
  async getTransactions(accountId: string): Promise<{ accountId: string, transactions: Transaction[] }> {
   ...
   */
  async getBalance(accountId: string): Promise<{ accountId: string, balance: number, lastUpdated: string }> {
